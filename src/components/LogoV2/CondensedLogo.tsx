...
export function CondensedLogo(): ReactNode {
  ...
  // Truncate version to fit within available width, accounting for "Olsc Code v" prefix
  const versionPrefix = 'Olsc Code v';
    ...
    <OffscreenFreeze>
      <Box flexDirection="row" gap={2} alignItems="center">
        ...
        <Box flexDirection="column">
          <Text>
            <Text bold>Olsc Code</Text> <Text dimColor>v{truncatedVersion}</Text>
          </Text>
          {shouldSplit ? (
            <>
