...
export type GlobalConfig = {
  ...
  firstStartTime?: string // ISO timestamp when Olsc Code was first started on this machine
  ...
  // Olsc Code usage tracking
  claudeCodeFirstTokenDate?: string // ISO timestamp of the user's first Olsc Code OAuth token
  ...
  // Olsc Code hint protocol state (<claude-code-hint /> tags from CLIs/SDKs).
